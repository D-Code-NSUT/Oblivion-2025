...
function WhyToStep() {
    return (
        <div id='WhyToStep' style={{ backgroundImage: `url("/why_to_step_into_oblivion-ship-bg.png")` }} className='min-h-screen flex justify-center items-center flex-col gap-4'>
