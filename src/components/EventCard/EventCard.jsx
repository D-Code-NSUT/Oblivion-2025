...
function EventCard({
    ...
    return (
        ...
        className='card bg-white flex flex-col items-center justify-center gap-2 w-[250px] h-[400px] relative hover:shadow-[0_0_40px_rgba(0,191,255,0.9),0_0_80px_rgba(0,191,255,0.4)] hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden flex-shrink-0 rounded-lg '>
