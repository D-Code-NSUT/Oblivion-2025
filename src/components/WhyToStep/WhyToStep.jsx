...
function WhyToStep() {
    ...
    return (
        <>
            ...
            <div id='WhyToStep' style={{ backgroundImage: `url("/why_to_step_into_oblivion-ship-bg.png")` }} className={`min-h-screen flex justify-center  flex-col gap-4 ${styles.darkBackground} py-11 relative overflow-hidden`}>
                ...
                <div
                    ref={elementRef}
                    className={`${isVisible ? styles.revealContainer : styles.hideContainer}`}>

                    <div className='lg:bg-white/10  lg:backdrop-blur-md   w-full flex justify-center py-7   lg:py-16 px-7 lg:border-t-2 lg:border-t-[#5CE4FF] lg:shadow-[0_0_20px_5px_#36B9C5] mt-0 lg:mt-7  '>
                        ...
                        <div className=' w-[90%] sm:w-[90%] mx-auto lg:w-full flex-wrap lg:flex-nowrap flex  gap-5 border-l-2 lg:border-0 py-2 lg:py-0'>
                            ...
                            <div className='flex flex-col relative items-start px-8 lg:px-0 lg:items-center text-center gap-2 before:content-[""] before:bg-black before:p-[15px] lg:before:p-[30px] before:border-[6px] before:border-[#5CE4FF] before:rounded-full before:absolute lg:before:top-[-94px] lg:before:left-[40%] before:top-0 before:left-[-22px] '>
                                ...
                                <div className='text-[15px] lg:text-[23px] font-bold font-source text-left'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci repudiandae voluptas quidem. Placeat, maxime illum.</div>
                            </div>
